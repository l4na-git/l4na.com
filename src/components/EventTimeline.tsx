...
const oneTimeActivities = [
  {
    ...
    description: "1年生だったこともあり、開発に関わることは難しかったですが積極的に参加しました。\n授業で学んでない技術や授業では扱わない技術に触れることができ、今後の学習への意欲を高めることができました。",
  },
  {
    date: "2024.11 - 2024.12",
    title: "ドロカツ 東日本大会",
    description: "周囲の先生から努力を認めてもらい、自分自身でも自信を持って「頑張った」「やりきった」と言えるくらい時間を費やしてチームの中心となってプログラムを書きました。\n当日実機が正常に動かないというアクシデントがあり悔しい思いをしましたが、たくさん悩んで試行錯誤をした経験は宝物だと感じています。",
  },
  {
    date: "2025.02",
    title: "基本情報技術者試験 合格",
  ...
  },
  {
    ...
    description: "公演や展示を通して、クラウド技術の最新動向を知ることができました。現地で盛り上がり感じることができ、学習へのモチベーションが高まりました。",
  },
  {
